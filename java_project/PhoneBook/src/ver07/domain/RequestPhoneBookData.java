...
public class RequestPhoneBookData {
	...
	public RequestPhoneBookData() {
	}

	public RequestPhoneBookData(int idx, String fr_name, String fr_phonenumber, String fr_email, String fr_address,
